...
struct _EsdashboardThemeEffectsPrivate
{
	/* Instance related */
	GSList			*effects;
};

G_DEFINE_TYPE_WITH_PRIVATE(EsdashboardThemeEffects,
							esdashboard_theme_effects,
							G_TYPE_OBJECT)
...
typedef struct _EsdashboardThemeEffectsPropertiesCollectData	EsdashboardThemeEffectsPropertiesCollectData;
struct _EsdashboardThemeEffectsPropertiesCollectData
{
	guint			index;
	guint			maxProperties;
	gchar			**names;
...
typedef struct _EsdashboardThemeEffectsParsedObject				EsdashboardThemeEffectsParsedObject;
struct _EsdashboardThemeEffectsParsedObject
{
	gint								refCount;
...
typedef struct _EsdashboardThemeEffectsParserData				EsdashboardThemeEffectsParserData;
struct _EsdashboardThemeEffectsParserData
{
	EsdashboardThemeEffects				*self;
...
static void _esdashboard_theme_effects_parse_set_error(EsdashboardThemeEffectsParserData *inParserData,
														GMarkupParseContext *inContext,
														GError **outError,
														EsdashboardThemeEffectsErrorEnum inCode,
														const gchar *inFormat,
														...) G_GNUC_PRINTF (5, 6);

#ifdef DEBUG
static void _esdashboard_theme_effects_print_parsed_objects_properties(gpointer inKey,
																		gpointer inValue,
																		gpointer inUserData)
{
	gchar		*key;
...
static void _esdashboard_theme_effects_print_parsed_objects(EsdashboardThemeEffectsParsedObject *inData, gpointer inUserData)
{
	const gchar			*prefix;
	...
	{
		g_hash_table_foreach(inData->properties, _esdashboard_theme_effects_print_parsed_objects_properties, NULL);
	}
														...
														...)
{
	...
	/* Create error object */
	tempError=g_error_new_literal(ESDASHBOARD_THEME_EFFECTS_ERROR, inCode, message);
	if(inParserData)
	{
 ...
 */
static GType _esdashboard_theme_effects_resolve_type_lazy(const gchar *inTypeName)
{
...
static gint _esdashboard_theme_effects_get_tag_by_name(const gchar *inTag)
{
...
static const gchar* _esdashboard_theme_effects_get_tag_by_id(guint inTagType)
{
...
static gboolean _esdashboard_theme_effects_has_id(EsdashboardThemeEffects *self,
													EsdashboardThemeEffectsParserData *inParsingEffects,
													const gchar *inID)
{
	EsdashboardThemeEffectsPrivate			*priv;
	GSList									*ids;
	gboolean								hasID;
	EsdashboardThemeEffectsParsedObject		*effect;

	g_return_val_if_fail(ESDASHBOARD_IS_THEME_EFFECTS(self), TRUE);
	...
	if(inParsingEffects)
	{
		...
		{
			effect=(EsdashboardThemeEffectsParsedObject*)ids->data;
...
static EsdashboardThemeEffectsParsedObject* _esdashboard_theme_effects_object_data_new(GMarkupParseContext *inContext,
																						gint inTagType,
																						GError **outError)
{
	EsdashboardThemeEffectsParsedObject		*objectData;

	g_return_val_if_fail(outError && *outError==NULL, NULL);

	/* Create object data */
	objectData=g_new0(EsdashboardThemeEffectsParsedObject, 1);
	if(!objectData)
	{
		_esdashboard_theme_effects_parse_set_error(NULL,
													inContext,
													outError,
													ESDASHBOARD_THEME_EFFECTS_ERROR_ERROR,
													"Cannot allocate memory for object data of tag <%s>",
													_esdashboard_theme_effects_get_tag_by_id(inTagType));
		return(NULL);
	}
...
static void _esdashboard_theme_effects_object_data_free(EsdashboardThemeEffectsParsedObject *inData)
{
	g_return_if_fail(inData);
...
static EsdashboardThemeEffectsParsedObject* _esdashboard_theme_effects_object_data_ref(EsdashboardThemeEffectsParsedObject *inData)
{
...
static void _esdashboard_theme_effects_object_data_unref(EsdashboardThemeEffectsParsedObject *inData)
{
	g_return_if_fail(inData);

	if(inData->refCount==1) _esdashboard_theme_effects_object_data_free(inData);
		else inData->refCount--;
}

static void _esdashboard_theme_effects_object_data_free_foreach_callback(gpointer inData, gpointer inUserData)
{
	EsdashboardThemeEffectsParsedObject		*data;

	g_return_if_fail(inData);

	data=(EsdashboardThemeEffectsParsedObject*)inData;

	/* Free tag data */
	_esdashboard_theme_effects_object_data_free(data);
}

/* Callback to add each successfully parsed effect object
 * to list of known effects of this theme.
 */
static void _esdashboard_theme_effects_add_effects_reference(gpointer inData, gpointer inUserData)
{
	EsdashboardThemeEffects					*self;
	EsdashboardThemeEffectsPrivate			*priv;
	EsdashboardThemeEffectsParsedObject		*data;

	g_return_if_fail(ESDASHBOARD_IS_THEME_EFFECTS(inUserData));
	g_return_if_fail(inData);

	self=ESDASHBOARD_THEME_EFFECTS(inUserData);
	priv=self->priv;
	data=(EsdashboardThemeEffectsParsedObject*)inData;

	/* Increase reference of specified effect and add to list of known ones */
	priv->effects=g_slist_prepend(priv->effects, _esdashboard_theme_effects_object_data_ref(data));
}

/* Create object and set up all properties */
static void _esdashboard_theme_effects_create_object_collect_properties(gpointer inKey,
																		gpointer inValue,
																		gpointer inUserData)
{
	const gchar										*name;
	const gchar										*value;
	EsdashboardThemeEffectsPropertiesCollectData	*data;
	...
	data=(EsdashboardThemeEffectsPropertiesCollectData*)inUserData;
...
static ClutterEffect* _esdashboard_theme_effects_create_object(EsdashboardThemeEffectsParsedObject *inObjectData)
{
	EsdashboardThemeEffectsPropertiesCollectData		collectData;
	GObject												*object;
	...
	if(collectData.maxProperties>0)
	{
		...
		g_hash_table_foreach(inObjectData->properties, _esdashboard_theme_effects_create_object_collect_properties, &collectData);
	}
...
static void _esdashboard_theme_effects_parse_general_no_text_nodes(GMarkupParseContext *inContext,
																	const gchar *inText,
																	gsize inTextLength,
																	gpointer inUserData,
																	GError **outError)
{
	EsdashboardThemeEffectsParserData			*data=(EsdashboardThemeEffectsParserData*)inUserData;
	gchar										*realText;
	...
	if(*realText)
	{
		...
		_esdashboard_theme_effects_parse_set_error(data,
													inContext,
													outError,
...
static void _esdashboard_theme_effects_parse_property_start(GMarkupParseContext *inContext,
															...
															GError **outError)
{
	...
	nextTag=_esdashboard_theme_effects_get_tag_by_name(inElementName);
	if(nextTag==-1)
	{
		_esdashboard_theme_effects_parse_set_error(data,
													inContext,
	...
	_esdashboard_theme_effects_parse_set_error(data,
												...
												_esdashboard_theme_effects_get_tag_by_id(currentTag),
												inElementName);
}

static void _esdashboard_theme_effects_parse_property_text_node(GMarkupParseContext *inContext,
																const gchar *inText,
																gsize inTextLength,
																gpointer inUserData,
																GError **outError)
{
	...
	/* Get object data */
	if(data->effects) objectData=(EsdashboardThemeEffectsParsedObject*)(data->effects->data);
	if(!objectData)
	{
		_esdashboard_theme_effects_parse_set_error(data,
													inContext,
...
static void _esdashboard_theme_effects_parse_object_start(GMarkupParseContext *inContext,
															const gchar *inElementName,
															const gchar **inAttributeNames,
															const gchar **inAttributeValues,
															gpointer inUserData,
															GError **outError)
{
	...
	gint										nextTag;
	GError										*error=NULL;
	EsdashboardThemeEffectsParsedObject			*objectData=NULL;
	...
	if(nextTag==TAG_PROPERTY)
	{
		static GMarkupParser					propertyParser=
												{
													_esdashboard_theme_effects_parse_property_start,
													NULL,
													_esdashboard_theme_effects_parse_property_text_node,
													NULL,
													NULL,
												};
		gchar									*name=NULL;
...
static void _esdashboard_theme_effects_parse_object_end(GMarkupParseContext *inContext,
															const gchar *inElementName,
															gpointer inUserData,
															GError **outError)
{
	...
	if(data->lastPropertyName)
	{
		...
		objectData=(EsdashboardThemeEffectsParsedObject*)(data->effects->data);
...
static void _esdashboard_theme_effects_parse_effects_start(GMarkupParseContext *inContext,
															const gchar *inElementName,
															const gchar **inAttributeNames,
															const gchar **inAttributeValues,
															gpointer inUserData,
															GError **outError)
{
	...
	if(nextTag==TAG_OBJECT)
	{
		static GMarkupParser					propertyParser=
												{
													_esdashboard_theme_effects_parse_object_start,
													_esdashboard_theme_effects_parse_object_end,
													_esdashboard_theme_effects_parse_general_no_text_nodes,
													NULL,
													NULL,
												};
		EsdashboardThemeEffectsParsedObject		*objectData;
		...
		/* Create tag data */
		objectData=_esdashboard_theme_effects_object_data_new(inContext, nextTag, &error);
		if(!objectData)
		{
			g_propagate_error(outError, error);
			return;
		...
		{
			g_propagate_error(outError, error);
			_esdashboard_theme_effects_object_data_unref(objectData);
			return;
		}
		...
		if(!esdashboard_is_valid_id(objectData->id))
		{
			_esdashboard_theme_effects_parse_set_error(data,
														inContext,
														outError,
		...
		if(_esdashboard_theme_effects_has_id(data->self, data, objectData->id))
		{
			_esdashboard_theme_effects_parse_set_error(data,
														inContext,
														outError,
		...
		objectData->classType=_esdashboard_theme_effects_resolve_type_lazy(objectData->className);
...
static void _esdashboard_theme_effects_parse_effects_end(GMarkupParseContext *inContext,
															const gchar *inElementName,
															gpointer inUserData,
															GError **outError)
{
...
static void _esdashboard_theme_effects_parse_document_start(GMarkupParseContext *inContext,
															const gchar *inElementName,
															const gchar **inAttributeNames,
															const gchar **inAttributeValues,
															gpointer inUserData,
															GError **outError)
{
	...
	if(nextTag==TAG_EFFECTS)
	{
		static GMarkupParser					propertyParser=
												{
													_esdashboard_theme_effects_parse_effects_start,
													_esdashboard_theme_effects_parse_effects_end,
													_esdashboard_theme_effects_parse_general_no_text_nodes,
													NULL,
													NULL,
												};
...
static void _esdashboard_theme_effects_parse_document_end(GMarkupParseContext *inContext,
															const gchar *inElementName,
															gpointer inUserData,
															GError **outError)
{
...
static gboolean _esdashboard_theme_effects_parse_xml(EsdashboardThemeEffects *self,
														const gchar *inPath,
														...
														GError **outError)
{
	static GMarkupParser				parser=
										{
											_esdashboard_theme_effects_parse_document_start,
											_esdashboard_theme_effects_parse_document_end,
											_esdashboard_theme_effects_parse_general_no_text_nodes,
											NULL,
											NULL,
										};

	EsdashboardThemeEffectsParserData	*data;
	GMarkupParseContext					*context;
	GError								*error;
	gboolean							success;

	g_return_val_if_fail(ESDASHBOARD_IS_THEME_EFFECTS(self), FALSE);
	...
	data=g_new0(EsdashboardThemeEffectsParserData, 1);
	if(!data)
	{
		/* Set error */
		g_set_error(outError,
					ESDASHBOARD_THEME_EFFECTS_ERROR,
					ESDASHBOARD_THEME_EFFECTS_ERROR_ERROR,
	...
	if(success)
	{
		g_slist_foreach(data->effects, (GFunc)_esdashboard_theme_effects_add_effects_reference, self);
	}
	...
	if(!success)
	{
		g_slist_foreach(data->effects, (GFunc)_esdashboard_theme_effects_print_parsed_objects, "Effects (this file):");
		g_slist_foreach(self->priv->effects, (GFunc)_esdashboard_theme_effects_print_parsed_objects, "Effects (parsed before):");
	...
	g_slist_free_full(data->effects, (GDestroyNotify)_esdashboard_theme_effects_object_data_unref);
...
/* Dispose this object */
static void _esdashboard_theme_effects_dispose(GObject *inObject)
{
	EsdashboardThemeEffects				*self=ESDASHBOARD_THEME_EFFECTS(inObject);
	EsdashboardThemeEffectsPrivate		*priv=self->priv;

	/* Release allocated resources */
	if(priv->effects)
	{
		g_slist_foreach(priv->effects, _esdashboard_theme_effects_object_data_free_foreach_callback, NULL);
		g_slist_free(priv->effects);
		priv->effects=NULL;
	}

	/* Call parent's class dispose method */
	G_OBJECT_CLASS(esdashboard_theme_effects_parent_class)->dispose(inObject);
}
 ...
 * and signals
 */
void esdashboard_theme_effects_class_init(EsdashboardThemeEffectsClass *klass)
{
	GObjectClass		*gobjectClass=G_OBJECT_CLASS(klass);

	/* Override functions */
	gobjectClass->dispose=_esdashboard_theme_effects_dispose;
}

/* Object initialization
 * Create private structure and set up default values
 */
void esdashboard_theme_effects_init(EsdashboardThemeEffects *self)
{
	EsdashboardThemeEffectsPrivate		*priv;

	priv=self->priv=esdashboard_theme_effects_get_instance_private(self);
...
{
	return(g_quark_from_static_string("esdashboard-theme-effects-error-quark"));
}
...
{
	return(ESDASHBOARD_THEME_EFFECTS(g_object_new(ESDASHBOARD_TYPE_THEME_EFFECTS, NULL)));
}
											...
											GError **outError)
{
	...
	_esdashboard_theme_effects_parse_xml(self, inPath, contents, &error);
	if(error)
	{
		g_propagate_error(outError, error);
		g_free(contents);
														...
														const gchar *inID)
{
	...
	while(entry)
	{
		objectData=(EsdashboardThemeEffectsParsedObject*)entry->data;

		/* If ID matches requested one create object */
		if(g_strcmp0(objectData->id, inID)==0)
		{
			/* Create object */
			effect=_esdashboard_theme_effects_create_object(objectData);
			return(effect);
		}
