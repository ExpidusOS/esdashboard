...
static void _esdashboard_text_box_focusable_iface_init(EsdashboardFocusableInterface *iface);

struct _EsdashboardTextBoxPrivate
{
	/* Properties related */
	gfloat					padding;
	gfloat					spacing;
...
G_DEFINE_TYPE_WITH_CODE(EsdashboardTextBox,
						esdashboard_text_box,
						ESDASHBOARD_TYPE_BACKGROUND,
						G_ADD_PRIVATE(EsdashboardTextBox)
						G_IMPLEMENT_INTERFACE(ESDASHBOARD_TYPE_FOCUSABLE, _esdashboard_text_box_focusable_iface_init))
...
static GParamSpec* EsdashboardTextBoxProperties[PROP_LAST]={ 0, };
...
static guint EsdashboardTextBoxSignals[SIGNAL_LAST]={ 0, };

/* IMPLEMENTATION: Private variables and methods */

/* Text of editable text box has changed */
static void _esdashboard_text_box_on_text_changed(EsdashboardTextBox *self, gpointer inUserData)
{
	EsdashboardTextBoxPrivate	*priv;
	ClutterText					*actorText;

	g_return_if_fail(ESDASHBOARD_IS_TEXT_BOX(self));
	...
	if(esdashboard_text_box_is_empty(self) && priv->isEditable)
	{
	...
	g_signal_emit(self, EsdashboardTextBoxSignals[SIGNAL_TEXT_CHANGED], 0, clutter_text_get_text(actorText));
}

/* Primary icon was clicked */
static void _esdashboard_text_box_on_primary_icon_clicked(EsdashboardTextBox *self,
															gpointer inUserData)
{
	g_return_if_fail(ESDASHBOARD_IS_TEXT_BOX(self));

	/* Emit signal for clicking primary icon */
	g_signal_emit(self, EsdashboardTextBoxSignals[SIGNAL_PRIMARY_ICON_CLICKED], 0);
}

/* Secondary icon was clicked */
static void _esdashboard_text_box_on_secondary_icon_clicked(EsdashboardTextBox *self,
															gpointer inUserData)
{
	g_return_if_fail(ESDASHBOARD_IS_TEXT_BOX(self));

	/* Emit signal for clicking secondary icon */
	g_signal_emit(self, EsdashboardTextBoxSignals[SIGNAL_SECONDARY_ICON_CLICKED], 0);
}

/* A key was pressed */
static gboolean _esdashboard_text_box_on_key_press_event(ClutterActor *inActor,
															ClutterEvent *inEvent,
															gpointer inUserData)
{
	EsdashboardTextBox			*self;
	EsdashboardTextBoxPrivate	*priv;
	gboolean					result;

	g_return_val_if_fail(ESDASHBOARD_IS_TEXT_BOX(inActor), CLUTTER_EVENT_PROPAGATE);

	self=ESDASHBOARD_TEXT_BOX(inActor);
	priv=self->priv;
...
/* A key was released */
static gboolean _esdashboard_text_box_on_key_release_event(ClutterActor *inActor,
															ClutterEvent *inEvent,
															gpointer inUserData)
{
	EsdashboardTextBox			*self;
...
/* Actor got key focus */
static void _esdashboard_text_box_key_focus_in(ClutterActor *inActor)
{
	EsdashboardTextBox			*self=ESDASHBOARD_TEXT_BOX(inActor);
	EsdashboardTextBoxPrivate	*priv=self->priv;
	ClutterStage				*stage;
	...
	esdashboard_focus_manager_set_focus(focusManager, ESDASHBOARD_FOCUSABLE(self));
	g_object_unref(focusManager);
}

/* Show all children of this one */
static void _esdashboard_text_box_show(ClutterActor *inActor)
{
	EsdashboardTextBox			*self=ESDASHBOARD_TEXT_BOX(inActor);
	EsdashboardTextBoxPrivate	*priv=self->priv;
...
static void _esdashboard_text_box_get_preferred_height(ClutterActor *self,
														gfloat inForWidth,
														gfloat *outMinHeight,
														gfloat *outNaturalHeight)
{
	EsdashboardTextBoxPrivate	*priv=ESDASHBOARD_TEXT_BOX(self)->priv;
...
static void _esdashboard_text_box_get_preferred_width(ClutterActor *self,
														gfloat inForHeight,
														gfloat *outMinWidth,
...
static void _esdashboard_text_box_allocate(ClutterActor *self,
											...
											ClutterAllocationFlags inFlags)
{
	...
	CLUTTER_ACTOR_CLASS(esdashboard_text_box_parent_class)->allocate(self, inBox, inFlags);
...
/* Destroy this actor */
static void _esdashboard_text_box_destroy(ClutterActor *self)
{
	...
	CLUTTER_ACTOR_CLASS(esdashboard_text_box_parent_class)->destroy(self);
}

/* IMPLEMENTATION: Interface EsdashboardFocusable */

/* Determine if actor can get the focus */
static gboolean _esdashboard_text_box_focusable_can_focus(EsdashboardFocusable *inFocusable)
{
	EsdashboardTextBox				*self;
	EsdashboardTextBoxPrivate		*priv;
	...
	g_return_val_if_fail(ESDASHBOARD_IS_TEXT_BOX(inFocusable), CLUTTER_EVENT_PROPAGATE);

	self=ESDASHBOARD_TEXT_BOX(inFocusable);
	priv=self->priv;
 ...
 */
void _esdashboard_text_box_focusable_iface_init(EsdashboardFocusableInterface *iface)
{
	iface->can_focus=_esdashboard_text_box_focusable_can_focus;
}

/* IMPLEMENTATION: GObject */

/* Dispose this object */
static void _esdashboard_text_box_dispose(GObject *inObject)
{
	EsdashboardTextBox			*self=ESDASHBOARD_TEXT_BOX(inObject);
	EsdashboardTextBoxPrivate	*priv=self->priv;
	...
	G_OBJECT_CLASS(esdashboard_text_box_parent_class)->dispose(inObject);
}

/* Set/get properties */
static void _esdashboard_text_box_set_property(GObject *inObject,
												guint inPropID,
												...
												GParamSpec *inSpec)
{
	...
	{
		case PROP_PADDING:
			esdashboard_text_box_set_padding(self, g_value_get_float(inValue));
			break;

		case PROP_SPACING:
			esdashboard_text_box_set_spacing(self, g_value_get_float(inValue));
			break;

		case PROP_EDITABLE:
			esdashboard_text_box_set_editable(self, g_value_get_boolean(inValue));
			break;

		case PROP_PRIMARY_ICON_NAME:
			esdashboard_text_box_set_primary_icon(self, g_value_get_string(inValue));
			break;

		case PROP_SECONDARY_ICON_NAME:
			esdashboard_text_box_set_secondary_icon(self, g_value_get_string(inValue));
			break;

		case PROP_TEXT:
			esdashboard_text_box_set_text(self, g_value_get_string(inValue));
			break;

		case PROP_TEXT_FONT:
			esdashboard_text_box_set_text_font(self, g_value_get_string(inValue));
			break;

		case PROP_TEXT_COLOR:
			esdashboard_text_box_set_text_color(self, clutter_value_get_color(inValue));
			break;

		case PROP_SELECTION_TEXT_COLOR:
			esdashboard_text_box_set_selection_text_color(self, clutter_value_get_color(inValue));
			break;

		case PROP_SELECTION_BACKGROUND_COLOR:
			esdashboard_text_box_set_selection_background_color(self, clutter_value_get_color(inValue));
			break;

		case PROP_HINT_TEXT:
			esdashboard_text_box_set_hint_text(self, g_value_get_string(inValue));
			break;

		case PROP_HINT_TEXT_FONT:
			esdashboard_text_box_set_hint_text_font(self, g_value_get_string(inValue));
			break;

		case PROP_HINT_TEXT_COLOR:
			esdashboard_text_box_set_hint_text_color(self, clutter_value_get_color(inValue));
			break;
...
static void _esdashboard_text_box_get_property(GObject *inObject,
												guint inPropID,
												GValue *outValue,
												GParamSpec *inSpec)
{
 ...
 * and signals
 */
static void esdashboard_text_box_class_init(EsdashboardTextBoxClass *klass)
{
	...
	/* Override functions */
	gobjectClass->dispose=_esdashboard_text_box_dispose;
	gobjectClass->set_property=_esdashboard_text_box_set_property;
	gobjectClass->get_property=_esdashboard_text_box_get_property;

	clutterActorClass->show_all=_esdashboard_text_box_show;
	clutterActorClass->get_preferred_width=_esdashboard_text_box_get_preferred_width;
	clutterActorClass->get_preferred_height=_esdashboard_text_box_get_preferred_height;
	clutterActorClass->allocate=_esdashboard_text_box_allocate;
	clutterActorClass->destroy=_esdashboard_text_box_destroy;
	clutterActorClass->key_focus_in=_esdashboard_text_box_key_focus_in;

	/* Define properties */
	EsdashboardTextBoxProperties[PROP_PADDING]=
	...
	EsdashboardTextBoxProperties[PROP_SPACING]=
	...
	EsdashboardTextBoxProperties[PROP_EDITABLE]=
		g_param_spec_boolean("editable",
								"Editable",
								"Flag to set if text is editable",
								FALSE,
								G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS);

	EsdashboardTextBoxProperties[PROP_PRIMARY_ICON_NAME]=
	...
	EsdashboardTextBoxProperties[PROP_SECONDARY_ICON_NAME]=
	...
	EsdashboardTextBoxProperties[PROP_TEXT]=
	...
	EsdashboardTextBoxProperties[PROP_TEXT_FONT]=
	...
	EsdashboardTextBoxProperties[PROP_TEXT_COLOR]=
	...
	EsdashboardTextBoxProperties[PROP_SELECTION_TEXT_COLOR]=
		clutter_param_spec_color("selection-text-color",
									"Selection text color",
									"Color of text of selected text",
									NULL,
									G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS);

	EsdashboardTextBoxProperties[PROP_SELECTION_BACKGROUND_COLOR]=
	...
	EsdashboardTextBoxProperties[PROP_HINT_TEXT]=
	...
	EsdashboardTextBoxProperties[PROP_HINT_TEXT_FONT]=
	...
	EsdashboardTextBoxProperties[PROP_HINT_TEXT_COLOR]=
	...
	EsdashboardTextBoxProperties[PROP_HINT_TEXT_SET]=
		g_param_spec_boolean("hint-text-set",
								"Hint text set",
								"Flag indicating if a hint text was set",
								FALSE,
								G_PARAM_READABLE | G_PARAM_STATIC_STRINGS);

	g_object_class_install_properties(gobjectClass, PROP_LAST, EsdashboardTextBoxProperties);

	/* Define stylable properties */
	esdashboard_actor_install_stylable_property(actorClass, EsdashboardTextBoxProperties[PROP_PADDING]);
	esdashboard_actor_install_stylable_property(actorClass, EsdashboardTextBoxProperties[PROP_SPACING]);
	esdashboard_actor_install_stylable_property(actorClass, EsdashboardTextBoxProperties[PROP_PRIMARY_ICON_NAME]);
	esdashboard_actor_install_stylable_property(actorClass, EsdashboardTextBoxProperties[PROP_SECONDARY_ICON_NAME]);
	esdashboard_actor_install_stylable_property(actorClass, EsdashboardTextBoxProperties[PROP_TEXT_FONT]);
	esdashboard_actor_install_stylable_property(actorClass, EsdashboardTextBoxProperties[PROP_TEXT_COLOR]);
	esdashboard_actor_install_stylable_property(actorClass, EsdashboardTextBoxProperties[PROP_SELECTION_BACKGROUND_COLOR]);
	esdashboard_actor_install_stylable_property(actorClass, EsdashboardTextBoxProperties[PROP_HINT_TEXT_FONT]);
	esdashboard_actor_install_stylable_property(actorClass, EsdashboardTextBoxProperties[PROP_HINT_TEXT_COLOR]);

	/* Define signals */
	EsdashboardTextBoxSignals[SIGNAL_TEXT_CHANGED]=
		g_signal_new("text-changed",
						G_TYPE_FROM_CLASS(klass),
						G_SIGNAL_RUN_LAST,
						G_STRUCT_OFFSET(EsdashboardTextBoxClass, text_changed),
						NULL,
						NULL,
	...
	EsdashboardTextBoxSignals[SIGNAL_PRIMARY_ICON_CLICKED]=
		g_signal_new("primary-icon-clicked",
						G_TYPE_FROM_CLASS(klass),
						G_SIGNAL_RUN_LAST,
						G_STRUCT_OFFSET(EsdashboardTextBoxClass, primary_icon_clicked),
						NULL,
						NULL,
	...
	EsdashboardTextBoxSignals[SIGNAL_SECONDARY_ICON_CLICKED]=
		g_signal_new("secondary-icon-clicked",
						G_TYPE_FROM_CLASS(klass),
						G_SIGNAL_RUN_LAST,
						G_STRUCT_OFFSET(EsdashboardTextBoxClass, secondary_icon_clicked),
						NULL,
						NULL,
						g_cclosure_marshal_VOID__VOID,
						G_TYPE_NONE,
 ...
 */
static void esdashboard_text_box_init(EsdashboardTextBox *self)
{
	EsdashboardTextBoxPrivate	*priv;

	priv=self->priv=esdashboard_text_box_get_instance_private(self);
	...
	/* Create actors */
	g_signal_connect(self, "key-press-event", G_CALLBACK(_esdashboard_text_box_on_key_press_event), NULL);
	g_signal_connect(self, "key-release-event", G_CALLBACK(_esdashboard_text_box_on_key_release_event), NULL);

	priv->actorPrimaryIcon=esdashboard_button_new();
	esdashboard_stylable_add_class(ESDASHBOARD_STYLABLE(priv->actorPrimaryIcon), "primary-icon");
	...
	g_signal_connect_swapped(priv->actorPrimaryIcon, "clicked", G_CALLBACK(_esdashboard_text_box_on_primary_icon_clicked), self);

	priv->actorSecondaryIcon=esdashboard_button_new();
	esdashboard_stylable_add_class(ESDASHBOARD_STYLABLE(priv->actorSecondaryIcon), "secondary-icon");
	...
	g_signal_connect_swapped(priv->actorSecondaryIcon, "clicked", G_CALLBACK(_esdashboard_text_box_on_secondary_icon_clicked), self);
	...
	g_signal_connect_swapped(priv->actorTextBox, "text-changed", G_CALLBACK(_esdashboard_text_box_on_text_changed), self);
...
void esdashboard_text_box_set_padding(EsdashboardTextBox *self, gfloat inPadding)
{
	...
	if(priv->padding!=inPadding)
	{
		...
		g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_PADDING]);
	}
}
...
void esdashboard_text_box_set_spacing(EsdashboardTextBox *self, gfloat inSpacing)
{
	...
	if(priv->spacing!=inSpacing)
	{
		...
		/* Notify about property change */
		g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_SPACING]);
	}
}
...
{
	g_return_val_if_fail(ESDASHBOARD_IS_TEXT_BOX(self), FALSE);
...
void esdashboard_text_box_set_editable(EsdashboardTextBox *self, gboolean isEditable)
{
	...
	if(priv->isEditable!=isEditable)
	{
		...
		if(priv->isEditable) esdashboard_stylable_add_pseudo_class(ESDASHBOARD_STYLABLE(self), "editable");
			else esdashboard_stylable_remove_pseudo_class(ESDASHBOARD_STYLABLE(self), "editable");
		...
		/* Notify about property change */
		g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_EDITABLE]);
	}
}
...
gboolean esdashboard_text_box_is_empty(EsdashboardTextBox *self)
{
	...
	g_return_val_if_fail(ESDASHBOARD_IS_TEXT_BOX(self), TRUE);
...
{
	g_return_val_if_fail(ESDASHBOARD_IS_TEXT_BOX(self), NULL);
...
void esdashboard_text_box_set_text(EsdashboardTextBox *self, const gchar *inMarkupText)
{
	...
	if(g_strcmp0(clutter_text_get_text(CLUTTER_TEXT(priv->actorTextBox)), inMarkupText)!=0)
	{
		...
		/* Notify about property change */
		g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_TEXT]);
	}
}

void esdashboard_text_box_set_text_va(EsdashboardTextBox *self, const gchar *inFormat, ...)
{
	gchar						*text;
	va_list						args;
	...
	/* Set formatted text */
	esdashboard_text_box_set_text(self, text);
...
void esdashboard_text_box_set_text_font(EsdashboardTextBox *self, const gchar *inFont)
{
	...
	if(g_strcmp0(priv->textFont, inFont)!=0)
	{
		...
		/* Notify about property change */
		g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_TEXT_FONT]);
	}
}
...
void esdashboard_text_box_set_text_color(EsdashboardTextBox *self, const ClutterColor *inColor)
{
	...
	if(!priv->textColor || !clutter_color_equal(inColor, priv->textColor))
	{
		...
		/* Notify about property change */
		g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_TEXT_COLOR]);
	}
}
...
void esdashboard_text_box_set_selection_text_color(EsdashboardTextBox *self, const ClutterColor *inColor)
{
			...
			!clutter_color_equal(inColor, priv->selectionTextColor)))
	{
		...
		if(priv->selectionTextColor)
		{
			...
			/* Notify about property change */
			g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_SELECTION_TEXT_COLOR]);
		}
...
void esdashboard_text_box_set_selection_background_color(EsdashboardTextBox *self, const ClutterColor *inColor)
{
			...
			!clutter_color_equal(inColor, priv->selectionBackgroundColor)))
	{
		...
		if(priv->selectionBackgroundColor)
		{
			...
			/* Notify about property change */
			g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_SELECTION_BACKGROUND_COLOR]);
		}
...
void esdashboard_text_box_set_hint_text(EsdashboardTextBox *self, const gchar *inMarkupText)
{
	...
	if(g_strcmp0(clutter_text_get_text(CLUTTER_TEXT(priv->actorHintLabel)), inMarkupText)!=0)
	{
		...
		/* Notify about property change */
		g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_HINT_TEXT]);
	}
	...
	if(newHintTextSet!=priv->hintTextSet)
	{
		...
		/* Notify about property change */
		g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_HINT_TEXT_SET]);
	}
...
void esdashboard_text_box_set_hint_text_va(EsdashboardTextBox *self, const gchar *inFormat, ...)
{
	gchar						*text;
	va_list						args;
	...
	/* Set formatted text */
	esdashboard_text_box_set_hint_text(self, text);
...
void esdashboard_text_box_set_hint_text_font(EsdashboardTextBox *self, const gchar *inFont)
{
	...
	if(g_strcmp0(priv->hintTextFont, inFont)!=0)
	{
		...
		/* Notify about property change */
		g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_HINT_TEXT_FONT]);
	}
}
...
void esdashboard_text_box_set_hint_text_color(EsdashboardTextBox *self, const ClutterColor *inColor)
{
	...
	if(!priv->hintTextColor || !clutter_color_equal(inColor, priv->hintTextColor))
	{
		...
		/* Notify about property change */
		g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_HINT_TEXT_COLOR]);
	}
}
...
void esdashboard_text_box_set_primary_icon(EsdashboardTextBox *self, const gchar *inIconName)
{
	...
	if(g_strcmp0(priv->primaryIconName, inIconName)!=0)
	{
		...
		if(inIconName)
		{
			...
			esdashboard_label_set_icon_name(ESDASHBOARD_LABEL(priv->actorPrimaryIcon), priv->primaryIconName);
		...
		/* Notify about property change */
		g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_PRIMARY_ICON_NAME]);
	}
}
...
void esdashboard_text_box_set_secondary_icon(EsdashboardTextBox *self, const gchar *inIconName)
{
	...
	if(g_strcmp0(priv->secondaryIconName, inIconName)!=0)
	{
		...
		if(inIconName)
		{
			...
			esdashboard_label_set_icon_name(ESDASHBOARD_LABEL(priv->actorSecondaryIcon), priv->secondaryIconName);
		...
		/* Notify about property change */
		g_object_notify_by_pspec(G_OBJECT(self), EsdashboardTextBoxProperties[PROP_SECONDARY_ICON_NAME]);
	}
}
