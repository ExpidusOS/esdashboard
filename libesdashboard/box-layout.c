 ...
 * @include: esdashboard/box-layout.h
 *
 * The #EsdashboardBoxLayout layout manager is a #ClutterBoxLayout derived layout
 ...
 * #EsdashboardBoxLayout layout manager to the #ClutterBoxLayout layout manager.
 */
...
G_DEFINE_TYPE(EsdashboardBoxLayout,
				esdashboard_box_layout,
...
static void _esdashboard_box_layout_allocate(ClutterLayoutManager *inLayoutManager,
													...
													ClutterAllocationFlags inFlags)
{
	...
	g_return_if_fail(ESDASHBOARD_IS_BOX_LAYOUT(inLayoutManager));
	g_return_if_fail(CLUTTER_IS_CONTAINER(inContainer));


	/* Chain up to calculate and store the allocation of children */
	CLUTTER_LAYOUT_MANAGER_CLASS(esdashboard_box_layout_parent_class)->allocate(inLayoutManager,
																				inContainer,
																				inAllocation,
																				inFlags);
 ...
 * and signals
 */
static void esdashboard_box_layout_class_init(EsdashboardBoxLayoutClass *klass)
{
	ClutterLayoutManagerClass	*layoutClass=CLUTTER_LAYOUT_MANAGER_CLASS(klass);

	/* Override functions */
	layoutClass->allocate=_esdashboard_box_layout_allocate;
}

/* Object initialization
 * Create private structure and set up default values
 */
static void esdashboard_box_layout_init(EsdashboardBoxLayout *self)
{
}
...
/* Create new instance */
/**
 * esdashboard_box_layout_new:
 *
 * Creates a new #EsdashboardBoxLayout layout manager
 *
 * Return value: The newly created #EsdashboardBoxLayout
 */
ClutterLayoutManager* esdashboard_box_layout_new(void)
{
	return(CLUTTER_LAYOUT_MANAGER(g_object_new(ESDASHBOARD_TYPE_BOX_LAYOUT, NULL)));
}
