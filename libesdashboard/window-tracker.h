...
#ifndef __LIBESDASHBOARD_WINDOW_TRACKER__
#define __LIBESDASHBOARD_WINDOW_TRACKER__
...
/* Object declaration */
#define ESDASHBOARD_TYPE_WINDOW_TRACKER				(esdashboard_window_tracker_get_type())
#define ESDASHBOARD_WINDOW_TRACKER(obj)				(G_TYPE_CHECK_INSTANCE_CAST((obj), ESDASHBOARD_TYPE_WINDOW_TRACKER, EsdashboardWindowTracker))
#define ESDASHBOARD_IS_WINDOW_TRACKER(obj)			(G_TYPE_CHECK_INSTANCE_TYPE((obj), ESDASHBOARD_TYPE_WINDOW_TRACKER))
#define ESDASHBOARD_WINDOW_TRACKER_GET_IFACE(obj)	(G_TYPE_INSTANCE_GET_INTERFACE((obj), ESDASHBOARD_TYPE_WINDOW_TRACKER, EsdashboardWindowTrackerInterface))

typedef struct _EsdashboardWindowTracker			EsdashboardWindowTracker;
typedef struct _EsdashboardWindowTrackerInterface	EsdashboardWindowTrackerInterface;

/**
 * EsdashboardWindowTrackerInterface:
 ...
 */
struct _EsdashboardWindowTrackerInterface
{
	/*< private >*/
	/* Parent interface */
	...
	/*< public >*/
	/* Virtual functions */
	GList* (*get_windows)(EsdashboardWindowTracker *self);
	GList* (*get_windows_stacked)(EsdashboardWindowTracker *self);
	EsdashboardWindowTrackerWindow* (*get_active_window)(EsdashboardWindowTracker *self);

	gint (*get_workspaces_count)(EsdashboardWindowTracker *self);
	GList* (*get_workspaces)(EsdashboardWindowTracker *self);
	EsdashboardWindowTrackerWorkspace* (*get_active_workspace)(EsdashboardWindowTracker *self);
	EsdashboardWindowTrackerWorkspace* (*get_workspace_by_number)(EsdashboardWindowTracker *self, gint inNumber);

	gboolean (*supports_multiple_monitors)(EsdashboardWindowTracker *self);
	gint (*get_monitors_count)(EsdashboardWindowTracker *self);
	GList* (*get_monitors)(EsdashboardWindowTracker *self);
	EsdashboardWindowTrackerMonitor* (*get_primary_monitor)(EsdashboardWindowTracker *self);
	EsdashboardWindowTrackerMonitor* (*get_monitor_by_number)(EsdashboardWindowTracker *self, gint inNumber);
	EsdashboardWindowTrackerMonitor* (*get_monitor_by_position)(EsdashboardWindowTracker *self, gint inX, gint inY);

	void (*get_screen_size)(EsdashboardWindowTracker *self, gint *outWidth, gint *outHeight);

	const gchar* (*get_window_manager_name)(EsdashboardWindowTracker *self);

	EsdashboardWindowTrackerWindow* (*get_root_window)(EsdashboardWindowTracker *self);

	/* Signals */
	void (*window_stacking_changed)(EsdashboardWindowTracker *self);

	void (*active_window_changed)(EsdashboardWindowTracker *self,
									EsdashboardWindowTrackerWindow *inOldWindow,
									EsdashboardWindowTrackerWindow *inNewWindow);
	void (*window_opened)(EsdashboardWindowTracker *self, EsdashboardWindowTrackerWindow *inWindow);
	void (*window_closed)(EsdashboardWindowTracker *self, EsdashboardWindowTrackerWindow *inWindow);
	void (*window_geometry_changed)(EsdashboardWindowTracker *self,EsdashboardWindowTrackerWindow *inWindow);
	void (*window_actions_changed)(EsdashboardWindowTracker *self, EsdashboardWindowTrackerWindow *inWindow);
	void (*window_state_changed)(EsdashboardWindowTracker *self, EsdashboardWindowTrackerWindow *inWindow);
	void (*window_icon_changed)(EsdashboardWindowTracker *self, EsdashboardWindowTrackerWindow *inWindow);
	void (*window_name_changed)(EsdashboardWindowTracker *self, EsdashboardWindowTrackerWindow *inWindow);
	void (*window_workspace_changed)(EsdashboardWindowTracker *self,
										EsdashboardWindowTrackerWindow *inWindow,
										EsdashboardWindowTrackerWorkspace *inWorkspace);
	void (*window_monitor_changed)(EsdashboardWindowTracker *self,
										EsdashboardWindowTrackerWindow *inWindow,
										EsdashboardWindowTrackerMonitor *inOldMonitor,
										EsdashboardWindowTrackerMonitor *inNewMonitor);

	void (*active_workspace_changed)(EsdashboardWindowTracker *self,
										EsdashboardWindowTrackerWorkspace *inOldWorkspace,
										EsdashboardWindowTrackerWorkspace *inNewWorkspace);
	void (*workspace_added)(EsdashboardWindowTracker *self, EsdashboardWindowTrackerWorkspace *inWorkspace);
	void (*workspace_removed)(EsdashboardWindowTracker *self, EsdashboardWindowTrackerWorkspace *inWorkspace);
	void (*workspace_name_changed)(EsdashboardWindowTracker *self, EsdashboardWindowTrackerWorkspace *inWorkspace);

	void (*primary_monitor_changed)(EsdashboardWindowTracker *self,
									EsdashboardWindowTrackerMonitor *inOldMonitor,
									EsdashboardWindowTrackerMonitor *inNewMonitor);
	void (*monitor_added)(EsdashboardWindowTracker *self, EsdashboardWindowTrackerMonitor *inMonitor);
	void (*monitor_removed)(EsdashboardWindowTracker *self, EsdashboardWindowTrackerMonitor *inMonitor);
	void (*monitor_geometry_changed)(EsdashboardWindowTracker *self, EsdashboardWindowTrackerMonitor *inMonitor);

	void (*screen_size_changed)(EsdashboardWindowTracker *self);

	void (*window_manager_changed)(EsdashboardWindowTracker *self);
};


/* Public API */
GType esdashboard_window_tracker_get_type(void) G_GNUC_CONST;
...
void esdashboard_window_tracker_get_screen_size(EsdashboardWindowTracker *self,
													gint *outWidth,
													gint *outHeight);
...
#endif	/* __LIBESDASHBOARD_WINDOW_TRACKER__ */
