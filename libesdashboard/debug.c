...
guint		esdashboard_debug_flags=0;
gchar		**esdashboard_debug_classes=NULL;
...
void esdashboard_debug_message(const char *inFormat, ...)
{
	va_list		args;

	va_start(args, inFormat);
	esdashboard_debug_messagev(inFormat, args);
	va_end(args);
}
